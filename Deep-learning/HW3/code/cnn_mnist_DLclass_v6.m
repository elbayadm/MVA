...
%------------------------Block 2
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(5,5,20,60, 'single'),zeros(1,60,'single')}}, ...
                           'stride', 1, ...
                           'pad', 0) ;
net.layers{end+1} = struct('type', 'pool', ...
                           'method', 'max', ...
                           ...
                           'stride', 2, ...
                           'pad', 0) ;
net.layers{end+1} = struct('type', 'maxout','g',4); 
%------------------------FC
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(4,4,15,500, 'single'),  zeros(1,500,'single')}}, ...
                           'stride', 1, ...
                           'pad', 0) ;
