...
%------------------------Block 2
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(5,5,10,50, 'single'),zeros(1,50,'single')}}, ...
                           'stride', 1, ...
                           'pad', 0) ;
net.layers{end+1} = struct('type', 'pool', ...
                           'method', 'max', ...
...
%------------------------FC
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(4,4,25,500, 'single'),  zeros(1,500,'single')}}, ...
                           'stride', 1, ...
                           'pad', 0) ;
