...
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(8,8,1,48, 'single'), zeros(1, 48, 'single')}}, ...
                           'stride', 1, ...
                           'pad', 1) ;
net.layers{end+1} = struct('type', 'maxout','g',2); 
...
net.layers{end+1} = struct('type', 'dropout','rate', .5) ; 

%------------------------Block 2
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(8,8,24,48, 'single'),zeros(1,48,'single')}}, ...
                           'stride', 1, ...
                           'pad', 3) ;
net.layers{end+1} = struct('type', 'maxout','g',2); 
net.layers{end+1} = struct('type', 'pool', ...
...
%------------------------Block 3
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(5,5,12,24, 'single'),zeros(1,24,'single')}}, ...
                           'stride', 1, ...
                           'pad', 3) ;
net.layers{end+1} = struct('type', 'maxout','g',2); 
net.layers{end+1} = struct('type', 'pool', ...
...
%------------------------FC
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(3,3,12,500, 'single'),  zeros(1,500,'single')}}, ...
                           'stride', 1, ...
                           'pad', 0) ;
