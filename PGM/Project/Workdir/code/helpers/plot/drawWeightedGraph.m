...
set(gcf,'Position',[0 0 1125 525])
axis([0 1 0 1]);
%set(gca,'XTick',[],'YTick',[],'box','on');
%set(gca,'XTick',[],'YTick',[]);
% Maha
axis off;
set(gcf,'PaperUnits','points','PaperType','A4','PaperPositionMode','auto','PaperOrientation','landscape')
% axis('square');
...
for i=1:N,
  ...
  for k=j,
    ...
    set(h, 'LineWidth', max(0.3,abs(weight)), 'Color',line_color);
  end;
end;
