#ifndef CAFFE_SOFTMAX_NOISY_LOSS_LAYER_HPP_
#define CAFFE_SOFTMAX_NOISY_LOSS_LAYER_HPP_
...
class SoftmaxNoisyLossLayer : public LossLayer<Dtype> {
 public:
  enum NoiseType {
    NoiseFree = 0,
    RandomNoise,
 ...
 public:
  explicit SoftmaxNoisyLossLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "SoftmaxNoisyLoss"; }
...
#endif  // CAFFE_SOFTMAX_NOISY_LOSS_LAYER_HPP_
